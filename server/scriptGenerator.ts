 ...
 */
export function generateDomainBlueprints(domain: TopicDomain, cleanTopic: string): SceneBlueprint[] {
  switch (domain) {
    case 'AI_AGRICULTURE':
      return [
        {
...
export async function generateSomaliScript(params: ScriptGenerationParams): Promise<{
  ...
  // =========================================================================
  // Case 2: Domain-Aware Blueprint Generation
  // =========================================================================
